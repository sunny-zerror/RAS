...
const ServicesCard = ({ title, description, buttons }) => {
  return (
    <div>
      <div className="w-full min-h-[22vh] flex flex-col overflow-hidden rounded-lg border-black border p-5 hover:border-transparent hover:bg-[#EA1B22] group transition-all duration-700">
