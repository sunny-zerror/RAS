    ...
    <div>
        <div className="w-full   pad flex items-center justify-between">
            <div className="h-full w-[40%] flex flex-col  gap-10 justify-evenly py-10 ">
                <div className="">
                <p className='text-3xl font-semibold'>RASSCS Stories</p>
                ...
                <p>From rapid crisis resolution to sustainable supply chain transformation, RASSCS consistently delivers where it counts. When a global chemical company faced a tank failure mid-transit, RAS activated its emergency response within hours—rerouting operations and resolving the issue without environmental impact.</p>
                <p>For an edible oil exporter, RASSCS implemented a customized Flexi Tank solution that reduced logistics costs by 15% and ensured zero contamination across multiple international shipments. Whether it’s enabling uninterrupted cold chains for pharmaceutical cargo or optimizing storage for chemical plants, our solutions are designed to deliver real-world value, safely and sustainably.</p>
                </div>
            </div>
