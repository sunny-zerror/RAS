...
const Section1 = () => {
  return (
    <div>
        <div id='home' className="w-full relative h-screen lg:h-[180vh] pt-[12vh]  bg-[url('/images/hero_section.webp')] bg-cover bg-center">
            ...
            <div className="w-full h-[30vh] md:h-[20vh] lg:h-[90vh]  flex items-center justify-end pr-0 md:pr-10 xl:pr-20">
                <div className=" w-full md:w-[38%]      h-full pad flex flex-col gap-5 justify-end">
                    ...
                    <p className=' text-xs lg:text-base leading-tight text-white'>RAS, a Goodrich company, focuses on supply chain continuity through a well connected agency network, building on delivering  solutions that are responsible, safe, and sustainable.
                    </p>
                </div>
            </div>
        </div>
