        ...
        <div className=' mt-10 lg:mt-32 '>
            <div className="w-full relative   pad ">
                <div className=" w-full  md:w-[50%] flex flex-col justify-center gap-4  ">
                    ...
                    <p className='  text-sm  lg:text-lg  leading-tight '>At RAS, we endeavor to create supply chain as interconnected systems rather than isolated transactions. This approach seeks therefore, to develop unified customer experience, resilience, and expertise across all touchpoints.</p>
                </div>
